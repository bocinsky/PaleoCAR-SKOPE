...
all.rasts.merge <- do.call(raster::merge, all.rasts[c(-7,-45)])
...
all.files <- list.files("/Volumes/DATA/PRISM/EXTRACTIONS/SKOPE_4CORNERS/PPT_water_year_demosaic",full.names=T)
